...
RMVideocapture::RMVideocapture(int cameramode)
{
    if(cameramode == 0)
    {
        cameraSet();
...
RMVideocapture::~RMVideocapture(void)
{
    if(iscamera0open)
    {
...
bool RMVideocapture::isindustryimgInput()
{
    if(iscamera0open == 1)
    {
...
void RMVideocapture::cameraReleasebuff()
{
    if(iscamera0open)
    {
